var data = {
    ...
    dosenti: {
        title: ["Berikut adalah kontak Dosen Teknologi Informasi:"],
        options: ['Ofelius Laia', 'Nov Elhan Gea', 'Jurisman Waruwu', 'Arliyanto Zai', 'Elisati Kurniawan Telaumbanua', 'Devi Chrisman Lase'],
        url: {}
    },
    ofeliuslaia: {
        title: ["Kontak Ofelius Laia, S.Kom., M.Kom"],
        options: ['Email', 'Whatsapp'],
        url: {
            link: ["mailto:ofelius.laia@unias.ac.id", "https://wa.me/6282161983105"]
        }
    },
    novelhangea: {
        title: ["Kontak Nov Elhan Gea, S.E., M.M"],
        options: ['Email', 'Whatsapp'],
        url: {
            link: ["mailto:nov.elhan.gea@unias.ac.id", "https://wa.me/6285262004333"]
        }
    },
    jurismanwaruwu: {
    ...
    arliyantozai: {
        title: ["Kontak Arliyanto Zai, S.Kom"],
        options: ['Email', 'Facebook'],
        url: {
            link: ["mailto:arliyanto.zai@unias.ac.id", "https://wa.me/6285262270726"]
        }
    },
    elisatikurniawantelaumbanua: {
        title: ["Kontak Elisati Kurniawan Telaumbanua, S.E., M.M"],
        options: ['Email', 'Facebook'],
        url: {
            link: ["mailto:elisati.kurniawan@unias.ac.id", "https://wa.me/6281325262472"]
        }
    },
    devichrismanlase: {
        title: ["Kontak Devi Chrisman Lase, S.Kom., M.Kom"],
        options: ['Email', 'Facebook'],
        url: {
            link: ["mailto:devi.chrisman@unias.ac.id", "https://wa.me/6281222206292"]
        }
    },
    pendaftaran: {
